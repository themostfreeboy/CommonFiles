...
void RSA_File_Code(const char* readfilename, const char* writefilename,int e,int n)//RSA算法的文件加密(此函数设计基于p=131,q=223,n=29213,e=133,d=217)
{
...
void RSA_File_Decode(const char* readfilename, const char* writefilename,int d,int n)//RSA算法的文件解密(此函数设计基于p=131,q=223,n=29213,e=133,d=217)
{
	errno_t err_read, err_write;
	FILE *fp_read = NULL;
	FILE *fp_write = NULL;
